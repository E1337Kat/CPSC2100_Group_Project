 ...
 * GTableModel Class
 * Author   : Amir Kost
 * Website  : http://www.developer.com/java/ent/article.php/927731/User-Code-A-TableModel-that-Allows-Column-Sorting.htm
...
public class GTableModel extends DefaultTableModel implements Comparator{
    ...
    /*******************************************************************
     * Following constructor created by Ellie for specific purpose in our System
     * @param columnNames
     * @param rowCount
     *******************************************************************/
    public GTableModel(Object[] columnNames, int rowCount) {
